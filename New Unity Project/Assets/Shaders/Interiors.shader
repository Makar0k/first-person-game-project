...
Shader "Custom/InteriorMapping - Cubemap"
{
    Properties
    {
        ...
        _ProjectionPosition("Position", Float) = (0, 0, 0)
        _TexturePosition("Sizing", Float) = (0, 0, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _Color;
            float3 _ProjectionPosition;
            float3 _TexturePosition;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
            #ifdef _USEOBJECTSPACE
                // room uvws
                float3 roomUVW = frac(i.uvw) + _ProjectionPosition.xyz;
            ...
            #else
                // room uvs
                float2 roomUV = frac(i.uv) + _ProjectionPosition.xy;
                ...
                fixed4 room = texCUBE(_RoomCube, pos.xyz + _TexturePosition.xyz);
                return fixed4(room.rgb * _Color, 1.0);
            }
            ENDCG
        }
    }
